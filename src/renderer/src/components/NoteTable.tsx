...
export default function NoteTable() {
  ...
  const rows = notes.map((note, i) => ({
    ...
    preview: {
      lineOne: note.username || 'username',
      lineTwo: note.website || 'www.example.com',
    },
    ...note,
  }))
    ...
    <React.Fragment>
      ...
      >
        <FormControl sx={{ flex: 1 }} size="sm">
          <FormLabel>Search for notes</FormLabel>
            ...
            <tr>
              <th style={{ width: 48, textAlign: 'center', padding: 12 }}>
                <Checkbox
                  ...
                  onChange={(event) => {
                    setSelected(event.target.checked ? rows.map((row) => row.name) : [])
                  }}
                  color={
              ...
              <th style={{ width: 220, padding: 12 }}>Preview</th>
              ...
              <tr key={row.name}>
                ...
                <td>
                  <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                    <Avatar size="sm">{row.preview.initial}</Avatar>
                    <div>
                      <Typography fontWeight="lg" level="body3" textColor="text.primary">
                        {row.preview.lineOne}
                      </Typography>
                      <Typography level="body3">{row.preview.lineTwo}</Typography>
                    </div>
                  </Box>
                </td>
                <td>
      ...
      >
        <Button size="sm" variant="plain" color="neutral" startDecorator={<ArrowLeft />}>
          Previous
        </Button>
        ...
        <Button size="sm" variant="plain" color="neutral" endDecorator={<ArrowRight />}>
          Next
        </Button>
      </Box>
    </React.Fragment>
